...
------------- | ------------- | -------------
[**createOrderPos()**](OrderPosApi.md#createOrderPos) | **POST** /OrderPos | Create a new order position
...
```php
createOrderPos($model_order_pos): \OpenAPI\Client\Model\InlineResponse2009
```

Create a new order position

Creates an order position for an order.
...
$model_order_pos = new \OpenAPI\Client\Model\ModelOrderPos(); // \OpenAPI\Client\Model\ModelOrderPos | Creation data. Please be aware, that you need to provide at least all required parameter      of the order position model!

try {
    $result = $apiInstance->createOrderPos($model_order_pos);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrderPosApi->createOrderPos: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **model_order_pos** | [**\OpenAPI\Client\Model\ModelOrderPos**](../Model/ModelOrderPos.md)| Creation data. Please be aware, that you need to provide at least all required parameter      of the order position model! | [optional]
...
```php
deleteOrderPos($order_pos_id): \OpenAPI\Client\Model\InlineResponse2004
```
...
```php
getOrderPositionById($order_pos_id): \OpenAPI\Client\Model\InlineResponse2009
```
...
```php
getOrderPositions($order_id, $order_object_name): \OpenAPI\Client\Model\InlineResponse2009
```
...
```php
updateOrderPosition($order_pos_id, $model_order_pos_update): \OpenAPI\Client\Model\InlineResponse2009
```
