...
**object_name** | **string** |  | [default to 'Voucher']
**create** | **\DateTime** | Date of voucher creation | [optional] [readonly]
**update** | **\DateTime** | Date of last voucher update | [optional] [readonly]
**sev_client** | [**\OpenAPI\Client\Model\ModelVoucherUpdateSevClient**](ModelVoucherUpdateSevClient.md) |  | [optional]
**create_user** | [**\OpenAPI\Client\Model\ModelVoucherUpdateCreateUser**](ModelVoucherUpdateCreateUser.md) |  | [optional]
