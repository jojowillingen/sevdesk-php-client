...
**order** | [**\OpenAPI\Client\Model\ModelOrderPosOrder**](ModelOrderPosOrder.md) |  |
...
**position_number** | **int** | Position number of your position. Can be used to order multiple positions. | [optional] [default to 1000]
