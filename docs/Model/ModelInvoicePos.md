...
**object_name** | **string** | The invoice position object name | [optional] [default to 'InvoicePos']
...
**invoice** | [**\OpenAPI\Client\Model\ModelInvoicePosInvoice**](ModelInvoicePosInvoice.md) |  |
