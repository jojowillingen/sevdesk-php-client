...
class ModelContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bank_number'] = $data['bank_number'] ?? null;
        $this->container['default_cashback_time'] = $data['default_cashback_time'] ?? null;
        $this->container['default_cashback_percent'] = $data['default_cashback_percent'] ?? null;
        $this->container['default_time_to_pay'] = $data['default_time_to_pay'] ?? null;
        $this->container['tax_number'] = $data['tax_number'] ?? null;
        $this->container['exempt_vat'] = $data['exempt_vat'] ?? null;
        $this->container['tax_type'] = $data['tax_type'] ?? null;
        $this->container['tax_set'] = $data['tax_set'] ?? null;
        $this->container['default_discount_amount'] = $data['default_discount_amount'] ?? null;
        $this->container['default_discount_percentage'] = $data['default_discount_percentage'] ?? null;
    }
