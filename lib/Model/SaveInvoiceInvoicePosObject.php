...
/**
 * SaveInvoiceInvoicePosObject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaveInvoiceInvoicePosObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveInvoiceInvoicePosObject';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object_name'] = $data['object_name'] ?? 'InvoicePos';
        ...
        $this->container['unity'] = $data['unity'] ?? null;
        $this->container['sev_client'] = $data['sev_client'] ?? null;
        $this->container['position_number'] = $data['position_number'] ?? null;
        $this->container['text'] = $data['text'] ?? null;
        $this->container['discount'] = $data['discount'] ?? null;
        $this->container['tax_rate'] = $data['tax_rate'] ?? null;
        $this->container['sum_discount'] = $data['sum_discount'] ?? null;
        ...
        $this->container['price_net'] = $data['price_net'] ?? null;
        $this->container['price_gross'] = $data['price_gross'] ?? null;
        $this->container['price_tax'] = $data['price_tax'] ?? null;
     ...
     * Gets invoice
     *
     * @return \OpenAPI\Client\Model\ModelInvoicePosInvoice
     */
     ...
     * Sets invoice
     *
     * @param \OpenAPI\Client\Model\ModelInvoicePosInvoice $invoice invoice
     *
     * @return self
     */
