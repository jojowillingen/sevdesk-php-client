...
/**
 * SaveCreditNoteCreditNotePosObject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaveCreditNoteCreditNotePosObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveCreditNoteCreditNotePosObject';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object_name'] = $data['object_name'] ?? 'CreditNotePos';
        ...
        $this->container['price_tax'] = $data['price_tax'] ?? 19;
        $this->container['price_gross'] = $data['price_gross'] ?? 119;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['unity'] = $data['unity'] ?? null;
        $this->container['sev_client'] = $data['sev_client'] ?? null;
        $this->container['position_number'] = $data['position_number'] ?? 1000;
