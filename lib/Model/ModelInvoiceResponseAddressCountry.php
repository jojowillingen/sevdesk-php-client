 ...
 */
class ModelInvoiceResponseAddressCountry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoiceResponse_addressCountry';
