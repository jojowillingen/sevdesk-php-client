 ...
 */
class ExportTransactionsCsvFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_Export_transactionsCsv_filter';
    ...
    {
        $this->container['paymt_purpose'] = $data['paymt_purpose'] ?? null;
