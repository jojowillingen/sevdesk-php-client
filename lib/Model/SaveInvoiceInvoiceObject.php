...
/**
 * SaveInvoiceInvoiceObject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaveInvoiceInvoiceObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveInvoiceInvoiceObject';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object_name'] = $data['object_name'] ?? 'Invoice';
