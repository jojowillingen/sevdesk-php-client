...
class ModelCheckAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['default_account'] = $data['default_account'] ?? null;
        $this->container['status'] = $data['status'] ?? self::STATUS_100;
        $this->container['bank_server'] = $data['bank_server'] ?? null;
        $this->container['auto_map_transactions'] = $data['auto_map_transactions'] ?? '1';
    }
     ...
     *
     * @param bool|null $default_account Defines if this check account is the default account.
     *
     * @return self
     */
