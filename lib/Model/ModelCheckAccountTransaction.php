...
class ModelCheckAccountTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payee_payer_name'] = $data['payee_payer_name'] ?? null;
        $this->container['check_account'] = $data['check_account'] ?? null;
        $this->container['status'] = $data['status'] ?? null;
        $this->container['enshrined'] = $data['enshrined'] ?? null;
        $this->container['source_transaction'] = $data['source_transaction'] ?? null;
        $this->container['target_transaction'] = $data['target_transaction'] ?? null;
    }
