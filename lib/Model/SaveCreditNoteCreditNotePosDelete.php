...
class SaveCreditNoteCreditNotePosDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveCreditNoteCreditNotePosDelete';
     ...
     * Sets id
     *
     * @param int $id ID of position to delete
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Object name of position
     *
     * @return self
     */
