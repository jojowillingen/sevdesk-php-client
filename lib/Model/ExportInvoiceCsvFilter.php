 ...
 */
class ExportInvoiceCsvFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_Export_invoiceCsv_filter';
    ...
    protected static $openAPITypes = [
        ...
        'start_date' => '\DateTime',
        'end_date' => '\DateTime',
        'contact' => '\OpenAPI\Client\Model\ExportInvoiceCsvFilterContact',
        'start_amount' => 'int',
        'end_amount' => 'int'
    ];
    ...
    public function setInvoiceType($invoice_type)
    {
        ...
        if (!is_null($invoice_type) && array_diff($invoice_type, $allowedValues)) {
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\ExportInvoiceCsvFilterContact|null
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\ExportInvoiceCsvFilterContact|null $contact contact
     *
     * @return self
     */
