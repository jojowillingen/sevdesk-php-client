...
class ModelPart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['stock_enabled'] = $data['stock_enabled'] ?? null;
        ...
        $this->container['price_purchase'] = $data['price_purchase'] ?? null;
        $this->container['tax_rate'] = $data['tax_rate'] ?? null;
        $this->container['status'] = $data['status'] ?? self::STATUS_100;
        $this->container['internal_comment'] = $data['internal_comment'] ?? null;
    }
