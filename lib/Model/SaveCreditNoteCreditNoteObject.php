<?php
/**
 * SaveCreditNoteCreditNoteObject
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * SaveCreditNoteCreditNoteObject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaveCreditNoteCreditNoteObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveCreditNoteCreditNoteObject';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object_name'] = $data['object_name'] ?? 'CreditNote';
        ...
        $this->container['credit_note_date'] = $data['credit_note_date'] ?? null;
        ...
        $this->container['delivery_terms'] = $data['delivery_terms'] ?? null;
        ...
        $this->container['credit_note_type'] = $data['credit_note_type'] ?? 'CN';
        $this->container['send_date'] = $data['send_date'] ?? null;
        $this->container['address'] = $data['address'] ?? null;
        $this->container['booking_category'] = $data['booking_category'] ?? null;
        ...
        $this->container['show_net'] = $data['show_net'] ?? null;
     ...
     *
     * @param string|null $booking_category defines the booking category, for more information see the section \"<a href='https://sevdesk1.gitlab.io/sevdesk-api-doku/#section/Credit-note-booking-categories'>Credit note booking categories</a>\"
     *
     * @return self
     */
