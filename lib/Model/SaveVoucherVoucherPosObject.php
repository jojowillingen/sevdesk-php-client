...
/**
 * SaveVoucherVoucherPosObject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaveVoucherVoucherPosObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveVoucherVoucherPosObject';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object_name'] = $data['object_name'] ?? 'VoucherPos';
        ...
        $this->container['estimated_accounting_type'] = $data['estimated_accounting_type'] ?? null;
        ...
        $this->container['sum_tax'] = $data['sum_tax'] ?? 19;
     ...
     * Sets net
     *
     * @param bool $net Determines whether 'sumNet' or 'sumGross' is regarded.<br>       If both are not given, 'sum' is regarded and treated as net or gross depending on 'net'.
     *
     * @return self
     */
