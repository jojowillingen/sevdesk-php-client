...
class CreditNoteApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\UNKNOWN_BASE_TYPE $unknown_base_type Creation data. Please be aware, that you need to provide at least all required parameter      of the creditNote model! (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse20110
     */
    public function createcreditNote($unknown_base_type = null)
    {
        list($response) = $this->createcreditNoteWithHttpInfo($unknown_base_type);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse20110, HTTP status code, HTTP response headers (array of strings)
     */
    public function createcreditNoteWithHttpInfo($unknown_base_type = null)
    {
        $request = $this->createcreditNoteRequest($unknown_base_type);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\InlineResponse20110' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20110' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InlineResponse20110', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\InlineResponse20110';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InlineResponse20110',
     ...
     */
    public function createcreditNoteAsync($unknown_base_type = null)
    {
        return $this->createcreditNoteAsyncWithHttpInfo($unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createcreditNoteAsyncWithHttpInfo($unknown_base_type = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20110';
        $request = $this->createcreditNoteRequest($unknown_base_type);
     ...
     */
    public function createcreditNoteRequest($unknown_base_type = null)
    {
     ...
     */
    public function creditNoteGetPdf($credit_note_id, $unknown_base_type = null)
    {
        list($response) = $this->creditNoteGetPdfWithHttpInfo($credit_note_id, $unknown_base_type);
        return $response;
    }
     ...
     */
    public function creditNoteGetPdfWithHttpInfo($credit_note_id, $unknown_base_type = null)
    {
        $request = $this->creditNoteGetPdfRequest($credit_note_id, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function creditNoteGetPdfAsync($credit_note_id, $unknown_base_type = null)
    {
        return $this->creditNoteGetPdfAsyncWithHttpInfo($credit_note_id, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function creditNoteGetPdfAsyncWithHttpInfo($credit_note_id, $unknown_base_type = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2001';
        $request = $this->creditNoteGetPdfRequest($credit_note_id, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function creditNoteGetPdfRequest($credit_note_id, $unknown_base_type = null)
    {
     ...
     */
    public function creditNoteSendBy($credit_note_id, $inline_object9 = null)
    {
        list($response) = $this->creditNoteSendByWithHttpInfo($credit_note_id, $inline_object9);
        return $response;
    }
     ...
     */
    public function creditNoteSendByWithHttpInfo($credit_note_id, $inline_object9 = null)
    {
        $request = $this->creditNoteSendByRequest($credit_note_id, $inline_object9);
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse20055' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20055' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function creditNoteSendByAsync($credit_note_id, $inline_object9 = null)
    {
        return $this->creditNoteSendByAsyncWithHttpInfo($credit_note_id, $inline_object9)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function creditNoteSendByAsyncWithHttpInfo($credit_note_id, $inline_object9 = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20055';
        $request = $this->creditNoteSendByRequest($credit_note_id, $inline_object9);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function creditNoteSendByRequest($credit_note_id, $inline_object9 = null)
    {
        // verify the required parameter 'credit_note_id' is set
        if ($credit_note_id === null || (is_array($credit_note_id) && count($credit_note_id) === 0)) {
            throw new \InvalidArgumentException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse2008' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse2008' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deletecreditNoteRequest($credit_note_id)
    {
        // verify the required parameter 'credit_note_id' is set
        if ($credit_note_id === null || (is_array($credit_note_id) && count($credit_note_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCreditNotesRequest($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getcreditNoteByIdRequest($credit_note_id)
    {
        // verify the required parameter 'credit_note_id' is set
        if ($credit_note_id === null || (is_array($credit_note_id) && count($credit_note_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  int $credit_note_id ID of creditNote to return (required)
     * @param  \OpenAPI\Client\Model\UNKNOWN_BASE_TYPE $unknown_base_type Mail data (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse2008
     */
    public function sendCreditNoteByPrinting($credit_note_id, $unknown_base_type = null)
    {
        list($response) = $this->sendCreditNoteByPrintingWithHttpInfo($credit_note_id, $unknown_base_type);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse2008, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendCreditNoteByPrintingWithHttpInfo($credit_note_id, $unknown_base_type = null)
    {
        $request = $this->sendCreditNoteByPrintingRequest($credit_note_id, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendCreditNoteByPrintingAsync($credit_note_id, $unknown_base_type = null)
    {
        return $this->sendCreditNoteByPrintingAsyncWithHttpInfo($credit_note_id, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendCreditNoteByPrintingAsyncWithHttpInfo($credit_note_id, $unknown_base_type = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2008';
        $request = $this->sendCreditNoteByPrintingRequest($credit_note_id, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendCreditNoteByPrintingRequest($credit_note_id, $unknown_base_type = null)
    {
        // verify the required parameter 'credit_note_id' is set
        if ($credit_note_id === null || (is_array($credit_note_id) && count($credit_note_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \OpenAPI\Client\Model\InlineResponse2008
     */
    public function sendCreditNoteViaEMail($credit_note_id, $inline_object8 = null)
    {
        list($response) = $this->sendCreditNoteViaEMailWithHttpInfo($credit_note_id, $inline_object8);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse2008, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendCreditNoteViaEMailWithHttpInfo($credit_note_id, $inline_object8 = null)
    {
        $request = $this->sendCreditNoteViaEMailRequest($credit_note_id, $inline_object8);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendCreditNoteViaEMailAsync($credit_note_id, $inline_object8 = null)
    {
        return $this->sendCreditNoteViaEMailAsyncWithHttpInfo($credit_note_id, $inline_object8)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendCreditNoteViaEMailAsyncWithHttpInfo($credit_note_id, $inline_object8 = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2008';
        $request = $this->sendCreditNoteViaEMailRequest($credit_note_id, $inline_object8);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendCreditNoteViaEMailRequest($credit_note_id, $inline_object8 = null)
    {
        // verify the required parameter 'credit_note_id' is set
        if ($credit_note_id === null || (is_array($credit_note_id) && count($credit_note_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \OpenAPI\Client\Model\InlineResponse2008
     */
    public function updatecreditNote($credit_note_id, $model_credit_note_update = null)
    {
        list($response) = $this->updatecreditNoteWithHttpInfo($credit_note_id, $model_credit_note_update);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse2008, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatecreditNoteWithHttpInfo($credit_note_id, $model_credit_note_update = null)
    {
        $request = $this->updatecreditNoteRequest($credit_note_id, $model_credit_note_update);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatecreditNoteAsync($credit_note_id, $model_credit_note_update = null)
    {
        return $this->updatecreditNoteAsyncWithHttpInfo($credit_note_id, $model_credit_note_update)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatecreditNoteAsyncWithHttpInfo($credit_note_id, $model_credit_note_update = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2008';
        $request = $this->updatecreditNoteRequest($credit_note_id, $model_credit_note_update);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatecreditNoteRequest($credit_note_id, $model_credit_note_update = null)
    {
        // verify the required parameter 'credit_note_id' is set
        if ($credit_note_id === null || (is_array($credit_note_id) && count($credit_note_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($model_credit_note_update)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($model_credit_note_update));
            } else {
