...
class CheckAccountTransactionApi
{
     ...
     */
    public function createTransaction($model_check_account_transaction = null)
    {
        list($response) = $this->createTransactionWithHttpInfo($model_check_account_transaction);
        return $response;
    }
     ...
     */
    public function createTransactionWithHttpInfo($model_check_account_transaction = null)
    {
        $request = $this->createTransactionRequest($model_check_account_transaction);
     ...
     */
    public function createTransactionAsync($model_check_account_transaction = null)
    {
        return $this->createTransactionAsyncWithHttpInfo($model_check_account_transaction)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTransactionAsyncWithHttpInfo($model_check_account_transaction = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2005';
        $request = $this->createTransactionRequest($model_check_account_transaction);
     ...
     */
    public function createTransactionRequest($model_check_account_transaction = null)
    {
        ...
        if (isset($model_check_account_transaction)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($model_check_account_transaction));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteCheckAccountTransactionRequest($check_account_transaction_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCheckAccountTransactionByIdRequest($check_account_transaction_id)
    {
        // verify the required parameter 'check_account_transaction_id' is set
        if ($check_account_transaction_id === null || (is_array($check_account_transaction_id) && count($check_account_transaction_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTransactionsRequest($check_account_id = null, $check_account_object_name = null, $is_booked = null, $paymt_purpose = null, $start_date = null, $end_date = null, $payee_payer_name = null, $only_credit = null, $only_debit = null)
    {
     ...
     * @return \OpenAPI\Client\Model\InlineResponse2005
     */
    public function updateCheckAccountTransaction($check_account_transaction_id, $model_check_account_transaction_update = null)
    {
        list($response) = $this->updateCheckAccountTransactionWithHttpInfo($check_account_transaction_id, $model_check_account_transaction_update);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse2005, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCheckAccountTransactionWithHttpInfo($check_account_transaction_id, $model_check_account_transaction_update = null)
    {
        $request = $this->updateCheckAccountTransactionRequest($check_account_transaction_id, $model_check_account_transaction_update);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCheckAccountTransactionAsync($check_account_transaction_id, $model_check_account_transaction_update = null)
    {
        return $this->updateCheckAccountTransactionAsyncWithHttpInfo($check_account_transaction_id, $model_check_account_transaction_update)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCheckAccountTransactionAsyncWithHttpInfo($check_account_transaction_id, $model_check_account_transaction_update = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2005';
        $request = $this->updateCheckAccountTransactionRequest($check_account_transaction_id, $model_check_account_transaction_update);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateCheckAccountTransactionRequest($check_account_transaction_id, $model_check_account_transaction_update = null)
    {
        // verify the required parameter 'check_account_transaction_id' is set
        if ($check_account_transaction_id === null || (is_array($check_account_transaction_id) && count($check_account_transaction_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($model_check_account_transaction_update)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($model_check_account_transaction_update));
            } else {
