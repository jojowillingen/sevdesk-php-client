...
class ContactApi
{
     ...
     */
    public function contactCustomerNumberAvailabilityCheckRequest($customer_number = null)
    {
     ...
     */
    public function createContact($model_contact = null)
    {
        list($response) = $this->createContactWithHttpInfo($model_contact);
        return $response;
    }
     ...
     */
    public function createContactWithHttpInfo($model_contact = null)
    {
        $request = $this->createContactRequest($model_contact);
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\InlineResponse20037' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20037' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createContactAsync($model_contact = null)
    {
        return $this->createContactAsyncWithHttpInfo($model_contact)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createContactAsyncWithHttpInfo($model_contact = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20037';
        $request = $this->createContactRequest($model_contact);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createContactRequest($model_contact = null)
    {
        ...
        if (isset($model_contact)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($model_contact));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactByIdRequest($contact_id)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse20028' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20028' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactTabsItemCountByIdRequest($contact_id)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactsRequest($depth = null, $customer_number = null)
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse20063' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20063' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getNextCustomerNumberRequest()
    {
     ...
     * @return \OpenAPI\Client\Model\InlineResponse20037
     */
    public function updateContact($contact_id, $model_contact_update = null)
    {
        list($response) = $this->updateContactWithHttpInfo($contact_id, $model_contact_update);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse20037, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateContactWithHttpInfo($contact_id, $model_contact_update = null)
    {
        $request = $this->updateContactRequest($contact_id, $model_contact_update);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateContactAsync($contact_id, $model_contact_update = null)
    {
        return $this->updateContactAsyncWithHttpInfo($contact_id, $model_contact_update)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateContactAsyncWithHttpInfo($contact_id, $model_contact_update = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20037';
        $request = $this->updateContactRequest($contact_id, $model_contact_update);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateContactRequest($contact_id, $model_contact_update = null)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($model_contact_update)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($model_contact_update));
            } else {
