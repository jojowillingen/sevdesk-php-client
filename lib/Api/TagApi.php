...
class TagApi
{
     ...
     * @return object
     */
    public function createTag($unknown_base_type = null)
    {
        list($response) = $this->createTagWithHttpInfo($unknown_base_type);
        return $response;
    }
     ...
     */
    public function createTagWithHttpInfo($unknown_base_type = null)
    {
        $request = $this->createTagRequest($unknown_base_type);
     ...
     */
    public function createTagAsync($unknown_base_type = null)
    {
        return $this->createTagAsyncWithHttpInfo($unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTagAsyncWithHttpInfo($unknown_base_type = null)
    {
        $returnType = 'object';
        $request = $this->createTagRequest($unknown_base_type);
     ...
     */
    public function createTagRequest($unknown_base_type = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTagRequest($tag_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagByIdRequest($tag_id)
    {
        // verify the required parameter 'tag_id' is set
        if ($tag_id === null || (is_array($tag_id) && count($tag_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagRelationsRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagsRequest($id = null, $name = null)
    {
     ...
     * @return object
     */
    public function updateTag($tag_id, $unknown_base_type = null)
    {
        list($response) = $this->updateTagWithHttpInfo($tag_id, $unknown_base_type);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTagWithHttpInfo($tag_id, $unknown_base_type = null)
    {
        $request = $this->updateTagRequest($tag_id, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTagAsync($tag_id, $unknown_base_type = null)
    {
        return $this->updateTagAsyncWithHttpInfo($tag_id, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTagAsyncWithHttpInfo($tag_id, $unknown_base_type = null)
    {
        $returnType = 'object';
        $request = $this->updateTagRequest($tag_id, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTagRequest($tag_id, $unknown_base_type = null)
    {
        // verify the required parameter 'tag_id' is set
        if ($tag_id === null || (is_array($tag_id) && count($tag_id) === 0)) {
            throw new \InvalidArgumentException(
