...
class VoucherApi
{
     ...
     */
    public function bookVoucher($voucher_id, $inline_object = null)
    {
        list($response) = $this->bookVoucherWithHttpInfo($voucher_id, $inline_object);
        return $response;
    }
     ...
     */
    public function bookVoucherWithHttpInfo($voucher_id, $inline_object = null)
    {
        $request = $this->bookVoucherRequest($voucher_id, $inline_object);
     ...
     */
    public function bookVoucherAsync($voucher_id, $inline_object = null)
    {
        return $this->bookVoucherAsyncWithHttpInfo($voucher_id, $inline_object)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bookVoucherAsyncWithHttpInfo($voucher_id, $inline_object = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse200';
        $request = $this->bookVoucherRequest($voucher_id, $inline_object);
     ...
     */
    public function bookVoucherRequest($voucher_id, $inline_object = null)
    {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse2012
     */
    public function createVoucherByFactory($inline_object3 = null)
    {
        list($response) = $this->createVoucherByFactoryWithHttpInfo($inline_object3);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse2012, HTTP status code, HTTP response headers (array of strings)
     */
    public function createVoucherByFactoryWithHttpInfo($inline_object3 = null)
    {
        $request = $this->createVoucherByFactoryRequest($inline_object3);
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\InlineResponse2012' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse2012' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createVoucherByFactoryAsync($inline_object3 = null)
    {
        return $this->createVoucherByFactoryAsyncWithHttpInfo($inline_object3)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createVoucherByFactoryAsyncWithHttpInfo($inline_object3 = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2012';
        $request = $this->createVoucherByFactoryRequest($inline_object3);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createVoucherByFactoryRequest($inline_object3 = null)
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse20031' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20031' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVoucherByIdRequest($voucher_id)
    {
        // verify the required parameter 'voucher_id' is set
        if ($voucher_id === null || (is_array($voucher_id) && count($voucher_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVouchersRequest($status = null, $credit_debit = null, $description_like = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null)
    {
     ...
     * @return \OpenAPI\Client\Model\InlineResponse20031
     */
    public function updateVoucher($voucher_id, $model_voucher_update = null)
    {
        list($response) = $this->updateVoucherWithHttpInfo($voucher_id, $model_voucher_update);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse20031, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateVoucherWithHttpInfo($voucher_id, $model_voucher_update = null)
    {
        $request = $this->updateVoucherRequest($voucher_id, $model_voucher_update);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVoucherAsync($voucher_id, $model_voucher_update = null)
    {
        return $this->updateVoucherAsyncWithHttpInfo($voucher_id, $model_voucher_update)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVoucherAsyncWithHttpInfo($voucher_id, $model_voucher_update = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20031';
        $request = $this->updateVoucherRequest($voucher_id, $model_voucher_update);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateVoucherRequest($voucher_id, $model_voucher_update = null)
    {
        // verify the required parameter 'voucher_id' is set
        if ($voucher_id === null || (is_array($voucher_id) && count($voucher_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($model_voucher_update)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($model_voucher_update));
            } else {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse20112
     */
    public function voucherUploadFile($inline_object11 = null)
    {
        list($response) = $this->voucherUploadFileWithHttpInfo($inline_object11);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse20112, HTTP status code, HTTP response headers (array of strings)
     */
    public function voucherUploadFileWithHttpInfo($inline_object11 = null)
    {
        $request = $this->voucherUploadFileRequest($inline_object11);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\InlineResponse20112' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20112' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InlineResponse20112', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\InlineResponse20112';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InlineResponse20112',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voucherUploadFileAsync($inline_object11 = null)
    {
        return $this->voucherUploadFileAsyncWithHttpInfo($inline_object11)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voucherUploadFileAsyncWithHttpInfo($inline_object11 = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20112';
        $request = $this->voucherUploadFileRequest($inline_object11);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function voucherUploadFileRequest($inline_object11 = null)
    {
