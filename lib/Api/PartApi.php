...
class PartApi
{
     ...
     */
    public function createPart($model_part = null)
    {
        list($response) = $this->createPartWithHttpInfo($model_part);
        return $response;
    }
     ...
     */
    public function createPartWithHttpInfo($model_part = null)
    {
        $request = $this->createPartRequest($model_part);
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\InlineResponse20034' === '\SplFileObject') {
                        ...
                        if ('\OpenAPI\Client\Model\InlineResponse20034' !== 'string') {
     ...
     */
    public function createPartAsync($model_part = null)
    {
        return $this->createPartAsyncWithHttpInfo($model_part)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPartAsyncWithHttpInfo($model_part = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20034';
        $request = $this->createPartRequest($model_part);
     ...
     */
    public function createPartRequest($model_part = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPartByIdRequest($part_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPartsRequest($part_number = null, $name = null)
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse20044' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20044' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function partGetStockRequest($part_id)
    {
        // verify the required parameter 'part_id' is set
        if ($part_id === null || (is_array($part_id) && count($part_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \OpenAPI\Client\Model\InlineResponse20034
     */
    public function updatePart($part_id, $model_part_update = null)
    {
        list($response) = $this->updatePartWithHttpInfo($part_id, $model_part_update);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse20034, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePartWithHttpInfo($part_id, $model_part_update = null)
    {
        $request = $this->updatePartRequest($part_id, $model_part_update);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePartAsync($part_id, $model_part_update = null)
    {
        return $this->updatePartAsyncWithHttpInfo($part_id, $model_part_update)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePartAsyncWithHttpInfo($part_id, $model_part_update = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20034';
        $request = $this->updatePartRequest($part_id, $model_part_update);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePartRequest($part_id, $model_part_update = null)
    {
        // verify the required parameter 'part_id' is set
        if ($part_id === null || (is_array($part_id) && count($part_id) === 0)) {
            throw new \InvalidArgumentException(
