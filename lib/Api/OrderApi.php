...
class OrderApi
{
     ...
     */
    public function createContractNoteFromOrder($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        list($response) = $this->createContractNoteFromOrderWithHttpInfo($order_id, $order_object_name, $model_create_packing_list_from_order);
        return $response;
    }
     ...
     */
    public function createContractNoteFromOrderWithHttpInfo($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        $request = $this->createContractNoteFromOrderRequest($order_id, $order_object_name, $model_create_packing_list_from_order);
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse20012' === '\SplFileObject') {
                        ...
                        if ('\OpenAPI\Client\Model\InlineResponse20012' !== 'string') {
     ...
     */
    public function createContractNoteFromOrderAsync($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        return $this->createContractNoteFromOrderAsyncWithHttpInfo($order_id, $order_object_name, $model_create_packing_list_from_order)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createContractNoteFromOrderAsyncWithHttpInfo($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20012';
        $request = $this->createContractNoteFromOrderRequest($order_id, $order_object_name, $model_create_packing_list_from_order);
     ...
     */
    public function createContractNoteFromOrderRequest($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        ...
        if (isset($model_create_packing_list_from_order)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($model_create_packing_list_from_order));
            } else {
     ...
     * Create a new order
     *
     * @param  \OpenAPI\Client\Model\ModelOrder $model_order Creation data. Please be aware, that you need to provide at least all required parameter      of the order model! (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse20012
     */
    public function createOrder($model_order = null)
    {
        list($response) = $this->createOrderWithHttpInfo($model_order);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse20012, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOrderWithHttpInfo($model_order = null)
    {
        $request = $this->createOrderRequest($model_order);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrderAsync($model_order = null)
    {
        return $this->createOrderAsyncWithHttpInfo($model_order)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrderAsyncWithHttpInfo($model_order = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20012';
        $request = $this->createOrderRequest($model_order);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createOrderRequest($model_order = null)
    {
        ...
        // for model (json/xml)
        if (isset($model_order)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($model_order));
            } else {
                $httpBody = $model_order;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \OpenAPI\Client\Model\InlineResponse20012
     */
    public function createPackingListFromOrder($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        list($response) = $this->createPackingListFromOrderWithHttpInfo($order_id, $order_object_name, $model_create_packing_list_from_order);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse20012, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPackingListFromOrderWithHttpInfo($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        $request = $this->createPackingListFromOrderRequest($order_id, $order_object_name, $model_create_packing_list_from_order);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPackingListFromOrderAsync($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        return $this->createPackingListFromOrderAsyncWithHttpInfo($order_id, $order_object_name, $model_create_packing_list_from_order)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPackingListFromOrderAsyncWithHttpInfo($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20012';
        $request = $this->createPackingListFromOrderRequest($order_id, $order_object_name, $model_create_packing_list_from_order);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createPackingListFromOrderRequest($order_id, $order_object_name, $model_create_packing_list_from_order = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse20011' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20011' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDiscountsRequest($order_id, $limit = null, $offset = null, $embed = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse2009' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse2009' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderPositionsByIdRequest($order_id, $limit = null, $offset = null, $embed = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrdersRequest($status = null, $order_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null)
    {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse20075
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse20075, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse20075' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20075' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRelatedObjectsRequest($order_id, $include_itself = null, $sort_by_type = null, $embed = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function orderGetPdf($order_id, $unknown_base_type = null)
    {
        list($response) = $this->orderGetPdfWithHttpInfo($order_id, $unknown_base_type);
        return $response;
    }
     ...
     */
    public function orderGetPdfWithHttpInfo($order_id, $unknown_base_type = null)
    {
        $request = $this->orderGetPdfRequest($order_id, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function orderGetPdfAsync($order_id, $unknown_base_type = null)
    {
        return $this->orderGetPdfAsyncWithHttpInfo($order_id, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function orderGetPdfAsyncWithHttpInfo($order_id, $unknown_base_type = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2001';
        $request = $this->orderGetPdfRequest($order_id, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderGetPdfRequest($order_id, $unknown_base_type = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function orderSendBy($order_id, $inline_object6 = null)
    {
        list($response) = $this->orderSendByWithHttpInfo($order_id, $inline_object6);
        return $response;
    }
     ...
     */
    public function orderSendByWithHttpInfo($order_id, $inline_object6 = null)
    {
        $request = $this->orderSendByRequest($order_id, $inline_object6);
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InlineResponse20045' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20045' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function orderSendByAsync($order_id, $inline_object6 = null)
    {
        return $this->orderSendByAsyncWithHttpInfo($order_id, $inline_object6)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function orderSendByAsyncWithHttpInfo($order_id, $inline_object6 = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20045';
        $request = $this->orderSendByRequest($order_id, $inline_object6);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderSendByRequest($order_id, $inline_object6 = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse20116
     */
    public function sendorderViaEMail($order_id, $inline_object12 = null)
    {
        list($response) = $this->sendorderViaEMailWithHttpInfo($order_id, $inline_object12);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse20116, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendorderViaEMailWithHttpInfo($order_id, $inline_object12 = null)
    {
        $request = $this->sendorderViaEMailRequest($order_id, $inline_object12);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\InlineResponse20116' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InlineResponse20116' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InlineResponse20116', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\InlineResponse20116';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InlineResponse20116',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendorderViaEMailAsync($order_id, $inline_object12 = null)
    {
        return $this->sendorderViaEMailAsyncWithHttpInfo($order_id, $inline_object12)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendorderViaEMailAsyncWithHttpInfo($order_id, $inline_object12 = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20116';
        $request = $this->sendorderViaEMailRequest($order_id, $inline_object12);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendorderViaEMailRequest($order_id, $inline_object12 = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \OpenAPI\Client\Model\InlineResponse20012
     */
    public function updateOrder($order_id, $model_order_update = null)
    {
        list($response) = $this->updateOrderWithHttpInfo($order_id, $model_order_update);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse20012, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrderWithHttpInfo($order_id, $model_order_update = null)
    {
        $request = $this->updateOrderRequest($order_id, $model_order_update);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrderAsync($order_id, $model_order_update = null)
    {
        return $this->updateOrderAsyncWithHttpInfo($order_id, $model_order_update)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrderAsyncWithHttpInfo($order_id, $model_order_update = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20012';
        $request = $this->updateOrderRequest($order_id, $model_order_update);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateOrderRequest($order_id, $model_order_update = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($model_order_update)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($model_order_update));
            } else {
